...
const Myprofile = () => {
  ...
  const countryOptions = ['India', 'China', 'Pakisthan', 'Japan', 'Russia', 'North Korea', 'South Korea', 'USA', 'UK', 'Malaysia', 'Nepal', 'Africa', 'Others'];
  ...
  const [image, setImage] = useState([]);
   ...
   async function uploadImage(event) {
    ...
    const URI = 'http://localhost:3000/user/upload-image';
        ...
        <div className="col-md-6">
          <div className="card">
            <div className="card-body p-5">
              ...
              <form method='POST' className='register-form p-3' id='register-form'>
                  ...
                  <div className="col-md-12">
                    <div className="form-section">
                      ...
                      <div className="form-outline mb-4">
                        ...
                        <input
                          type="text" name="text" id="formstate" className="form-control form-control-lg" placeholder='Enter Your State' autoComplete='off' required />
                      </div>

                      <div className="form-outline mb-4">
                        <label className="form-label" htmlFor="labelCity"><i className="zmdi "></i> City</label>
                        <input
                          type="text" name="text" id="formcity" className="form-control form-control-lg" placeholder='City' autoComplete='off' required />
                      </div>
                  ...
                  <div className="col-md-12">
                    <div className="form-section">
                      ...
                      <div className="form-outline mb-4">
                        ...
                        <input className="m-3" type="radio" id="veg" name="food" value="veg" required />
                        <label htmlFor="veg">Veg</label>

                        <input className="m-3" type="radio" id="nonveg" name="food" value="nonveg" required />
                        <label htmlFor="nonveg">Non-Veg</label>
                      </div>

                      <div className="form-outline mb-4">
                        <label className="form-label">Drink :</label>
                        <input className="m-3" type="radio" id="yesDrink" name="drink" value="yes" required />
                        <label htmlFor="yesDrink">Yes</label>

                        <input className="m-3" type="radio" id="noDrink" name="drink" value="no" required />
                        <label htmlFor="noDrink">No</label>
                      </div>

                      <div className="form-outline mb-4">
                        <label className="form-label">Smoke :</label>
                        <input className="m-3" type="radio" id="yesSmoke" name="smoke" value="yes" required />
                        <label htmlFor="yesSmoke">Yes</label>

                        <input className="m-3" type="radio" id="noSmoke" name="smoke" value="no" required />
                  ...
                  <div className="col-md-12">
                    <div className="form-section">
                      ...
                      <div className="form-outline mb-4">
                        ...
                        <select className="form-select" name="bodyColor" required>
                  ...
                  <div className="col-md-12">
                    <div className="form-section">
                      ...
                      <div className="form-outline mb-4">
                        ...
                        <select className="form-select" name="professionalStatus" required>
                      ...
                      <div className="form-outline mb-4">
                        ...
                        <input className="form-control" type="text" name="work" />
                      </div>
                ...
                <div className="form-outline form-group form-button text-center">
                  <input type='submit' name='updateProfile' id="updateProfile" className='btn btn-primary btn-lg' value="Update Profile" onClick="" />
                </div>
